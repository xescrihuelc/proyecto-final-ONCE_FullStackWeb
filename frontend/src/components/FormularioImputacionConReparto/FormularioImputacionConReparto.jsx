...
export default function FormularioImputacionConReparto({ resumen, tareas }) {
  ...
  items.forEach((item, i) => {
    ...
    if (Math.abs(porDia - redondeado) > 1e-3) {
      console.warn(`Valor por día (${porDia.toFixed(4)}) redondeado a ${redondeado}h`);
    }
  ...
  return (
    <div className="formulario-imputacion-reparto">
      <h3>Asignar horas a tareas ({resumen.diasTrabajados} días trabajados)</h3>
      <table>
        <thead>
          <tr>
            <th>Tarea</th>
