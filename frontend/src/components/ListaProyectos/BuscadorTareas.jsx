...
import { getAllTasks, assignTaskToUser } from "../../services/taskService";
...
const BuscadorTareas = () => {
    ...
    const handleAsignar = async (entry) => {
        ...
        try {
            ...
            alert(
                `✅ “${entry.subtareaNombre}” de “${
                    entry.proyectoNombre
                }” asignada a ${usuarios.find((u) => u._id === userId).email}`
            );
                    ...
                    >
                        ...
                        <div className="tarea-acciones">
                            <select
                                ...
                                onChange={(ev) =>
                                    handleSelect(e.id, ev.target.value)
                                }
                            >
                            ...
                            <button onClick={() => handleAsignar(e)}>
                                Asignar
                            </button>
                        </div>
                    </li>
