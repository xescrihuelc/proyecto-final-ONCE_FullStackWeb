...
const BACKEND_URL = "http://localhost:8080"; // Ajusta según tu backend
...
const CrearProyecto = () => {
    ...
    const handleUsuarioQuitar = (id) => {
        setUsuariosSeleccionados(
            usuariosSeleccionados.filter((u) => u._id !== id)
        );
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!res.ok) {
                ...
                throw new Error(
                    errorData.error || "Error al crear el proyecto"
                );
            }
                ...
                <div className="checkbox-group">
                    <label>
                        <input
                            ...
                            onChange={(e) =>
                                setEsProyectoEuropeo(e.target.checked)
                            }
                        />
                        Proyecto Europeo
                    </label>
